        ...
        <div class="py-2 w-full">
            ...
            <div class="relative flex items-center w-full">
                ...
                <div class="bg-black rounded-lg w-[calc(100%-50px)] text-sm w-full font-light">
                    ...
                    <img v-if="post && post.picture" class="mx-auto w-full pt-2 pr-2 rounded" :src="post.picture" alt="post image"/>
            ...
            <div class="flex items-center">
                <div class="flex items-center flex-wrap text-white gap-1 w-[42px]">
                    <div class="flex gap-0.5">
                        <img src="https://picsum.photos/id/202/50" class="mt-2 rounded-full h-[14px]" alt="image"/>
                        <img src="https://picsum.photos/id/223/50" class="rounded-full h-[17px]" alt="image"/>
                    </div>
                    <div class="flex items-center">
                        <img class="rounded-full h-[11px] ml-4" src="https://picsum.photos/id/99/50" alt="image"/>
                    </div>
                </div>
            </div>
        </div>
